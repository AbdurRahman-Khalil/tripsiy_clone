...
export const ContactUs = () => {
    ...
    return (
        <div id="contact-us" className="bg-white px-6 min-[431px]:px-9 md:px-12 lg:px-16 pt-12 pb-[4.25em]">
            ...
            <section
                ...
                className="flex flex-col min-[680px]:flex-row justify-center items-start gap-[3.75em] min-[685px]:gap-[4em] min-[750px]:gap-[4.5em]"
            >
                <ContactForm />
                <ContactInfo />
            </section>

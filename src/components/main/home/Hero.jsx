...
export const Hero = () => {
    return (
        <section id="home-hero" className="flex justify-center items-center">
            <div className="text-white text-center px-6 min-[431px]:px-9 sm:px-14 py-32">
                <h1 id="hero-heading" className="text-[3rem] sm:text-[3.5rem] font-bold tracking-[0.5%] max-[999px]:leading-[1.35em] max-[999px]:mb-2">

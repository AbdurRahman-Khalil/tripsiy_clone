...
export const Footer = () => {
    ...
    return (
        <footer id="footer" className="footer-bg-gradient pt-20">
            <div className="footer-top max-w-[1440px] mx-auto px-12 flex justify-center items-start flex-wrap gap-36">
                <div className="self-center">
                    <Logo logoSize={115} />
                    <p className="text-sm font-medium tracking-[0.5%] text-[#5A4B3C] mt-3">Your trusted travel partner for <br /> unforgettable adventures.</p>
                </div>
                <div>
                ...
                <div>
                    ...
                    <address className="mt-8 space-y-5">
                ...
                <div>
                    ...
                    <div className="mt-5 flex items-center gap-3.5 -ml-1">
                        <a href="https://web.facebook.com" className="hover:scale-110 hover:rotate-[25deg] transition-all duration-200 ease-linear">
                            <img src={facebookIcon} alt="facebook icon" />
                        </a>
                        <a href="https://www.instagram.com" className="hover:scale-110 hover:rotate-[-25deg] transition-all duration-200 ease-linear">
                            <img src={instagramIcon} alt="instagram icon" />
                        </a>
                        <a href="https://web.whatsapp.com" className="hover:scale-110 hover:rotate-[25deg] transition-all duration-200 ease-linear">
